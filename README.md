...
- **Loss**      : _![loss](http://latex.codecogs.com/svg.latex?%20\textbf{w}%20\times%20classifier%20\hspace{1mm}%20loss%20+%20\lambda%20\times%20discriminator%20\hspace{1mm}%20loss%20\hspace{1mm}%20\(\textbf{w}%20%3D%20classifier%20\hspace{1mm}%20loss%20\hspace{1mm}%20weight%20\hspace{1mm}%20[set%20\hspace{1mm}to%20\hspace{1mm}1]%20\hspace{1mm}and%20\hspace{1mm}\lambda%20%3D%20discriminator%20\hspace{1mm}loss%20\hspace{1mm}weight)_
